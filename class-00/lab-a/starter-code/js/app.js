...
const viewed = [];
const labels = [];
const pics = [leftImage, centerImage, rightImage];let list = document.getElementById('productlist');
let totalClicks = 0;
const views = [];
const votes = [];
...
function displayPics(){
  ...
  // Let is locally scoped, so the console.log threw an error, because is was called outside the function.
  console.log(viewed);
